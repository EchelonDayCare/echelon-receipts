...
<body><div class="sheet">
  ...
  <div class="foot">
    Generated by Echelon Receipts — Deposit #${deposit.id} — Bank fields to be completed at branch.
  </div>
</div></body></html>`;
}
