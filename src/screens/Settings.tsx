  ...
  function renderStaff() {
    return (
      <div className="card">
        ...
        {/* ── OCR pipeline (v2 grid engine — always on since v2.6.8) ──── */}
        <hr style={{ border: 0, borderTop: "1px solid var(--border)", margin: "16px 0" }} />
        <div style={{ marginBottom: 8 }}>
          <strong>OCR pipeline (v2 grid engine)</strong>
          <div style={{ color: "var(--muted)", fontSize: 13, marginTop: 4 }}>
            Grid-primitive engine — global per-column reads, joint IN/OUT resolution, three-bucket output (confident / needs review / couldn&apos;t read).
          </div>
        </div>
