...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            backup_crypto::export_plaintext_backup,
            backup_crypto::export_encrypted_backup,
            ...
            website::tour::website_tour_delete_video,
            website::tour::website_tour_reorder_videos,
            website::gallery_videos::website_gallery_videos_list,
            website::gallery_videos::website_gallery_videos_add,
            website::gallery_videos::website_gallery_videos_delete,
            website::gallery_videos::website_gallery_videos_reorder,
